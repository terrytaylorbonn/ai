...
#        print("hand_sign_text = ", hand_sign_text)
 ...
 #       print("finger_gesture_text = ", finger_gesture_text)
    ...
    if (info_text == "Right") and (hand_sign_text == "Open") and (flight_mode == "AUTO"):
...
#    return image
    ...
    if info_text == "Right" and hand_sign_text == "Close" and flight_mode == "GUIDED":
...
message = connection.mav.command_long_encode(
         ...
         #-----------------------------------------------------------------
         1,    #                                          # param1 
         21196, #21196 force arm  , 0 otherwise                               # param2 
         0,                                              # param3
         0,                                              # param4
         0,                                              # param5
         0,                                              # param6
