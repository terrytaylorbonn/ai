...
message = connection.mav.command_long_encode(
         ...
         0,                                              # param6
         0)                                              # param7
print("4modearmmmmmmmmmm")
# Send COMMAND_INT     
connection.mav.send(message)
print("5modarmmmmmmmmmmmmmmmm")
...
message = connection.mav.command_long_encode(
         ...
         0,                                              # param6
         11)                                              # param7
print("4modeartakeofffffffffffffffffff")
# Send COMMAND_INT     
connection.mav.send(message)
print("5modartakeofffffffffffffffffff")
...
# #*****TERRY: THIS is all commented out…...
